  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application - Bridging the gap in urban transportation. Making every journey more convenient, economical, and eco-friendly. Your ride, anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application - Bridging the gap in urban transportation. Making every journey more convenient, economical, and eco-friendly. Your ride, anytime, anywhere.`}
            </Text>
            <Box
